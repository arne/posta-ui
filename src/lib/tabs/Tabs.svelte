...
<script lang="ts">
  ...
  export let contentClass: string = 'mt-4';
  ...
  const styledActiveClasses = {
    ...
    underline:
      'p-4 text-primary-600 border-b-2 border-red-600 dark:text-primary-500 dark:border-red-500',
    none: '',
  };
  ...
  $: ulClass = cn(defaultClass, style === 'underline' && '-mb-px', $$props.class);
</script>
