...
export class LemmyHttp {
  ...
  leaveAdmin(form: LeaveAdmin) {
    return this.#wrapper<LeaveAdmin, GetSiteResponse>(HttpType.Post, '/user/leave_admin', form);
  }
  ...
  getModlog(form: GetModlog) {
    return this.#wrapper<GetModlog, GetModlogResponse>(HttpType.Get, '/modlog', form);
  }
  ...
  createCommunity(form: CreateCommunity) {
    return this.#wrapper<CreateCommunity, CommunityResponse>(HttpType.Post, '/community', form);
  }
  ...
  getCommunity(form: GetCommunity) {
    return this.#wrapper<GetCommunity, GetCommunityResponse>(HttpType.Get, '/community', form);
  }
  ...
  editCommunity(form: EditCommunity) {
    return this.#wrapper<EditCommunity, CommunityResponse>(HttpType.Put, '/community', form);
  }
  ...
  deletePost(form: DeletePost) {
    return this.#wrapper<DeletePost, PostResponse>(HttpType.Post, '/post/delete', form);
  }
  ...
  removePost(form: RemovePost) {
    return this.#wrapper<RemovePost, PostResponse>(HttpType.Post, '/post/remove', form);
  }
  ...
  markPostAsRead(form: MarkPostAsRead) {
    return this.#wrapper<MarkPostAsRead, PostResponse>(HttpType.Post, '/post/mark_as_read', form);
  }
  ...
  lockPost(form: LockPost) {
    return this.#wrapper<LockPost, PostResponse>(HttpType.Post, '/post/lock', form);
  }
  ...
  featurePost(form: FeaturePost) {
    return this.#wrapper<FeaturePost, PostResponse>(HttpType.Post, '/post/feature', form);
  }
  ...
  getPosts(form: GetPosts) {
    return this.#wrapper<GetPosts, GetPostsResponse>(HttpType.Get, '/post/list', form);
  }
  ...
  likePost(form: CreatePostLike) {
    return this.#wrapper<CreatePostLike, PostResponse>(HttpType.Post, '/post/like', form);
  }
  ...
  savePost(form: SavePost) {
    return this.#wrapper<SavePost, PostResponse>(HttpType.Put, '/post/save', form);
  }
  ...
  createPostReport(form: CreatePostReport) {
    return this.#wrapper<CreatePostReport, PostReportResponse>(HttpType.Post, '/post/report', form);
  }
  ...
  createComment(form: CreateComment) {
    return this.#wrapper<CreateComment, CommentResponse>(HttpType.Post, '/comment', form);
  }
  ...
  editComment(form: EditComment) {
    return this.#wrapper<EditComment, CommentResponse>(HttpType.Put, '/comment', form);
  }
  ...
  deleteComment(form: DeleteComment) {
    return this.#wrapper<DeleteComment, CommentResponse>(HttpType.Post, '/comment/delete', form);
  }
  ...
  removeComment(form: RemoveComment) {
    return this.#wrapper<RemoveComment, CommentResponse>(HttpType.Post, '/comment/remove', form);
  }
  ...
  likeComment(form: CreateCommentLike) {
    return this.#wrapper<CreateCommentLike, CommentResponse>(HttpType.Post, '/comment/like', form);
  }
  ...
  saveComment(form: SaveComment) {
    return this.#wrapper<SaveComment, CommentResponse>(HttpType.Put, '/comment/save', form);
  }
  ...
  getComments(form: GetComments) {
    return this.#wrapper<GetComments, GetCommentsResponse>(HttpType.Get, '/comment/list', form);
  }
  ...
  getComment(form: GetComment) {
    return this.#wrapper<GetComment, CommentResponse>(HttpType.Get, '/comment', form);
  }
  ...
  createPrivateMessageReport(form: CreatePrivateMessageReport) {
    return this.#wrapper<CreatePrivateMessageReport, PrivateMessageReportResponse>(
      HttpType.Post,
  ...
  listPrivateMessageReports(form: ListPrivateMessageReports) {
    return this.#wrapper<ListPrivateMessageReports, ListPrivateMessageReportsResponse>(
      HttpType.Get,
  ...
  register(form: Register) {
    return this.#wrapper<Register, LoginResponse>(HttpType.Post, '/user/register', form);
  }
   ...
   */
  login(form: Login) {
    return this.#wrapper<Login, LoginResponse>(HttpType.Post, '/user/login', form);
  }
  ...
  getPersonDetails(form: GetPersonDetails) {
    return this.#wrapper<GetPersonDetails, GetPersonDetailsResponse>(HttpType.Get, '/user', form);
  }
  ...
  getReplies(form: GetReplies) {
    return this.#wrapper<GetReplies, GetRepliesResponse>(HttpType.Get, '/user/replies', form);
  }
  ...
  banPerson(form: BanPerson) {
    return this.#wrapper<BanPerson, BanPersonResponse>(HttpType.Post, '/user/ban', form);
  }
  ...
  blockPerson(form: BlockPerson) {
    return this.#wrapper<BlockPerson, BlockPersonResponse>(HttpType.Post, '/user/block', form);
  }
  ...
  getCaptcha(form: GetCaptcha) {
    return this.#wrapper<GetCaptcha, GetCaptchaResponse>(HttpType.Get, '/user/get_captcha', form);
  }
  ...
  addAdmin(form: AddAdmin) {
    return this.#wrapper<AddAdmin, AddAdminResponse>(HttpType.Post, '/admin/add', form);
  }
   ...
   */
  getUnreadRegistrationApplicationCount(form: GetUnreadRegistrationApplicationCount) {
    return this.#wrapper<
  ...
  listRegistrationApplications(form: ListRegistrationApplications) {
    return this.#wrapper<ListRegistrationApplications, ListRegistrationApplicationsResponse>(
      HttpType.Get,
  ...
  approveRegistrationApplication(form: ApproveRegistrationApplication) {
    return this.#wrapper<ApproveRegistrationApplication, RegistrationApplicationResponse>(
      HttpType.Put,
  ...
  purgePost(form: PurgePost) {
    return this.#wrapper<PurgePost, PurgeItemResponse>(HttpType.Post, '/admin/purge/post', form);
  }
  ...
  async editCustomEmoji(form: EditCustomEmoji) {
    return this.#wrapper<EditCustomEmoji, CustomEmojiResponse>(HttpType.Put, '/custom_emoji', form);
  }
   ...
   */
  async uploadImage({ image, auth }: UploadImage): Promise<UploadImageResponse> {
